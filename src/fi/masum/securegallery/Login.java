<<<<<<< HEAD:src/fi/masum/securegallery/SecureNote.java
...
public class Login extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (checkDataBase()) {
			...
			Log.i(tag, "no db so register a user. error");
	...
	private void LoginUser() {
		...
		btnLogin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				/////// ################## I start from here ###########	
					//txtMsg.setText("Log is successful");
//					Intent startNewActivityOpen = new Intent(SecureNote.this,
//							NotesList.class);
...
>>>>>>> Update to FrameLayout. All activity is FrameLayout now.:src/fi/masum/securegallery/Login.java
